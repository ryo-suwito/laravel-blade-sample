        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-sm-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{ route("cms.yukk_co.rintis_log.list_inbound") }}" class="breadcrumb-item">@lang("cms.RINTIS Logs")</a>
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">@lang("cms.RINTIS Log")</h5>
        </div>

        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    @foreach ((array)$rintis_request_log as $field_name => $value)
