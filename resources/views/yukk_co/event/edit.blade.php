    ...
    <div class="page-header page-header-light">
        <div class="page-header-content d-sm-flex">
            <div class="page-title">
                <h5 class="card-title">@lang("cms.Edit Event") - {{ $event->name }}</h5>
            </div>
        </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-sm-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">@lang("cms.Edit Event")</span>
                </div>
            </div>
        </div>
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">@lang("cms.Edit Event")</h5>
        </div>

        <form method="post" enctype="multipart/form-data" action="{{ route('yukk_co.event.update', $event->id) }}">
            @csrf
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="code" id="code" value="{{ $event->code }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <textarea type="text" class="form-control" name="short_description" id="short_description">{{ $event->short_description }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="start_date" id="start_date" value="{{ @\App\Helpers\H::formatDateTimeWithoutTime($event->start_date) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="end_date" id="end_date" value="{{ @\App\Helpers\H::formatDateTimeWithoutTime($event->end_date) }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="event_organizer_name" id="event_organizer_name" value="{{ $event->event_organizer_name }}">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="event_organizer_code" id="event_organizer_code" value="{{ $event->event_organizer_code }}">
                    </div>
                </div>
