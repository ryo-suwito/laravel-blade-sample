...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="{{ route("cms.yukk_co.payment_channel.update_status", $payment_channel->id) }}">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <select class="form-control" name="active" id="active">
                                    <option value="1" @if(old("active", $payment_channel->active)) selected @endif>@lang("cms.Active")</option>
                                    <option value="0" @if(! old("active", $payment_channel->active)) selected @endif>@lang("cms.Inactive")</option>
                                </select>
                            </div>
                        </div>
