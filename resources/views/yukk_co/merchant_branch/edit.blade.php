    ...
    <div class="page-header page-header-light">
        <div class="page-header-content d-sm-flex">
            <div class="page-title">
                <h4>@lang('cms.Edit Merchant Branch')</h4>
            </div>
        </div>
...
@section('content')
    <div class="panel panel-flat">
        <div class="panel-body">
            <form method="post" enctype="multipart/form-data" action="{{ route('yukk_co.merchant_branch.update', $merchant_branch->id) }}">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6 form-horizontal">
                                ...
                                <div class="col-9">
                                    <select class="form-control select2" name="owner_id" id="owner_id">
                                        ...
                                        @foreach ($owners as $owner)
                                            <option @if(old("owner_id", $merchant_branch->owner_id) == $owner->id) selected @endif value="{{ $owner->id }}">{{ $owner->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input type="hidden" name="partner_id" id="partner_id" value="{{ @$partner_has_merchant_branch->partner->id }}">
                                    <input type="text" class="form-control" name="partner" id="partner" value="{{ @$partner_has_merchant_branch->partner->name }}" readonly>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" name="name" id="name" value="{{ $merchant_branch->name }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <select class="form-control @if ($errors->has("type")) is-invalid @endif" name="type" id="type">
                                        <option value="ONLINE" @if(old("type", @$merchant_branch->type) == "ONLINE") selected @endif>@lang("cms.ONLINE")</option>
                                        <option value="OFFLINE" @if(old("type", @$merchant_branch->type) == "OFFLINE") selected @endif>@lang("cms.OFFLINE")</option>
                                        <option value="BOTH" @if(old("type", @$merchant_branch->type) == "BOTH") selected @endif>@lang("cms.BOTH")</option>
                                    </select>
                                    @if ($errors->has("type"))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" name="start_time" id="start_time" value="{{ $start_date }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-3 mt-1">@lang("cms.End Date")</label>
                                <div class="col-9">
                                    <input type="text" class="form-control" name="end_time" id="end_time" value="{{ $end_date }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-3 mt-1">@lang("cms.Total Terminal (Kasir)")</label>
                                <div class="col-9">
                                    <input type="number" class="form-control" name="total_terminal" id="total_terminal" value="{{ $merchant_branch->total_terminal }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <select class="form-control @if ($errors->has("qr_type")) is-invalid @endif" name="qr_type" id="qr_type">
                                        <option value="b" @if(old("qr_type", $merchant_branch->qr_type) == "b") selected @endif>@lang("cms.Both (Static and Dynamic)")</option>
                                        <option value="s" @if(old("qr_type", $merchant_branch->qr_type) == "s") selected @endif>@lang("cms.Static Only")</option>
                                        <option value="d" @if(old("qr_type", $merchant_branch->qr_type) == "d") selected @endif>@lang("cms.Dynamic Only")</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" readonly name="longitude" id="longitude" value="{{ $merchant_branch->longitude }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-3 mt-1">@lang("cms.Latitude")</label>
                                <div class="col-9">
                                    <input type="text" class="form-control" readonly name="latitude" id="latitude" value="{{ $merchant_branch->latitude }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <select class="form-control select2" name="province" id="province">
                                        ...
                                        @foreach ($province as $item)
                                            <option value="{{ $item->id }}" @if(old("province", $merchant_branch->province->id) == $item->id) selected @endif>{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <input type="text" class="form-control" name="postal_code" id="postal_code" value="{{ $merchant_branch->zipcode }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-3 mt-1">@lang("cms.Address")</label>
                                <div class="col-9">
                                    <textarea class="form-control" name="address" id="address">{{ $merchant_branch->address }}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-3 mt-1">@lang("cms.Status")</label>
                                <div class="col-9">
                                    <select class="form-control select2" name="status" id="status">
                                        <option value="0" @if($merchant_branch->active == 0) selected @endif>@lang("cms.Inactive")</option>
                                        <option value="1" @if($merchant_branch->active == 1) selected @endif>@lang("cms.Active")</option>
                                    </select>
                                </div>
                            </div>
                        </div>
...
//                    google.maps.event.addDomListener(window, 'load', initAutocomplete);
    ...
    <script>
        $(document).ready(function () {        
            ...
            // var start_date convert php date to js date
...
@section('post_scripts')
    <script>
         $(document).ready(function() {
            var companyName = "{{ @$merchant_branch->merchant->company->name }}";

            var existingCompany = $("<option selected='selected'></option>")
                .val("{{ @$merchant_branch->merchant->company->id }}")
                .text("{{ @$merchant_branch->merchant->company->name }}");
            $("#company_id").append(existingCompany);

            var existingMerchant = $("<option selected='selected'></option>")
                .val("{{ @$merchant_branch->merchant->id }}")
                .text("{{ @$merchant_branch->merchant->name }}");
            $("#merchant_id").append(existingMerchant);

            var existingProvince = $("<option selected='selected'></option>")
                .val("{{ @$merchant_branch->province->id }}")
                .text("{{ @$merchant_branch->province->name }}");
            $("#province").append(existingProvince);

            var existingCity = $("<option selected='selected'></option>")
                .val("{{ @$merchant_branch->city->id }}")
                .text("{{ @$merchant_branch->city->name }}");
            $("#city").append(existingCity);

            var existingRegion = $("<option selected='selected'></option>")
                .val("{{ @$merchant_branch->region->id }}")
                .text("{{ @$merchant_branch->region->name }}");
            $("#region").append(existingRegion);

            // var existingPartner = $("<option selected='selected'></option>")
            //     .val("{{ @$partner_has_merchant_branch->partner->id }}")
            //     .text("{{ @$partner_has_merchant_branch->partner->name }}");
            // $("#partner_id").append(existingPartner);
