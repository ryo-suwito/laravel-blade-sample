        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-sm-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">@lang("cms.QRIS ReHit RINTIS")</span>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    @if (\App\Helpers\AccessControlHelper::checkCurrentAccessControl("QRIS_RE_HIT.CREATE", "AND"))
                        <a href="{{ route("cms.yukk_co.qris_re_hit_rintis.create") }}" type="button" class="btn btn-primary w-100 w-sm-auto float-right">@lang("cms.Add New") @lang("cms.QRIS ReHit RINTIS")</a>
                    @endif
                </div>
            </div>

            <form action="{{ route("cms.yukk_co.qris_re_hit_rintis.list") }}" method="get">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <td class="text-center">
                            <div class="list-icons">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="{{ route("cms.yukk_co.qris_re_hit_rintis.item", $qris_re_hit->id) }}" class="dropdown-item"><i class="icon-search4"></i> @lang("cms.Detail")</a>
                                    </div>
                                </div>
                            </div>
                        </td>
