...
<form id="form-owner" action="{{ route('yukk_co.owners.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <!-- General Information -->
    <div class="row">
        <!-- General Information -->
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="name" id="name" class="form-control" placeholder="@lang('cms.Name')" required autofocus>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="phone" id="phone" class="form-control" placeholder="@lang('cms.Phone')" inputmode="numeric" pattern="[0-9]*">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="email" name="email" id="email" required class="form-control" placeholder="@lang('cms.Email')">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <textarea name="address" id="address" rows="3" required class="form-control" placeholder="@lang('cms.Address')"></textarea>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" disabled name="bank_account_number" id="bank_account_number" class="form-control" placeholder="@lang('cms.Account Number')" inputmode="numeric" pattern="[0-9]*">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" disabled name="bank_account_name" id="bank_account_name" class="form-control" placeholder="@lang('cms.Account Name')">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" disabled name="bank_account_branch" id="bank_account_branch" class="form-control" placeholder="@lang('cms.Bank Branch Name')">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-group row" id="previewKtpContainerRow" style="display: none;">
                                ...
                                <div class="row">
                                    <div class="col-lg-12" style="margin-top:10px">
                                        <div id="previewContainer" style="position: relative;">
                                            ...
                                            <img src="#" alt="" id="file_ktp_preview" style="width: 100%; height: auto;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="number" min="0" max="16" id="id_card_number" name="id_card_number"
                                    class="form-control" placeholder="@lang('cms.KTP No')"
                                    value="{{ old('id_card_number') }}" inputmode="numeric" pattern="[0-9]*" data-rule-minlength="16"
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-group row" id="previewSelfieContainerRow" style="display: none;">
                            <label class="col-lg-4 col-form-label"></label>
                            <div class="col-lg-8">
                                <div class="row">
                                    <div class="col-lg-12" style="margin-top:10px">
                                        <div id="previewContainer" style="position: relative;">
                                            ...
                                            <img src="#" alt="" id="file_selfie_preview" style="width: 100%; height: auto;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-group row" id="previewNpwpContainerRow" style="display: none;">
                            <label class="col-lg-4 col-form-label"></label>
                            <div class="col-lg-8">
                                <div class="row">
                                    <div class="col-lg-12" style="margin-top:10px">
                                        <div id="previewContainer" style="position: relative;">
                                            ...
                                            <img src="#" alt="" id="file_npwp_preview" style="width: 100%; height: auto;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="number" min="15" max="16" id="npwp_number" name="npwp_number" class="form-control"
                                    placeholder="@lang('cms.NPWP No')" value="{{ old('npwp_number') }}"
            ...
            <div class="modal-body">
                <div id="ktpDetailsContent">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" form="form-owner" class="form-control" data_form_id_card data_form_id_card_number>
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-lg-8">
                            <input type="text" form="form-owner" name="id_card_name" id="id_card_name" class="form-control" data_form_id_card data_form_id_card_name>
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-lg-8">
                            <input type="text" form="form-owner" name="id_card_date_of_birth" class="form-control" data_form_id_card data_form_id_card_date_of_birth>
                    ...
                    <div class="form-group row mt-3">
                        ...
                        <div class="col-lg-8">
                            <input type="text" form="form-owner" name="id_card_place_of_birth" class="form-control" data_form_id_card data_form_id_card_place_of_birth>
                    ...
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label" for="id_card_address">@lang('cms.Address')</label>
                        <div class="col-lg-8">
                            <input type="text" form="form-owner" name="id_card_address" id="id_card_address" class="form-control" placeholder="@lang('cms.Address')" data_form_id_card data_form_id_card_address>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" form="form-owner" name="id_card_gender" id="id_card_gender" class="form-control" placeholder="@lang('cms.Gender')" data_form_id_card data_form_id_card_gender>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8 d-flex flex-column">
                            <input type="text" form="form-owner" name="id_card_marital_status" id="id_card_marital_status" class="form-control" placeholder="@lang('cms.Marital Status')" data_form_id_card data_form_id_card_marital_status>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" form="form-owner" name="id_card_job" id="id_card_job" class="form-control" placeholder="@lang('cms.Job')" data_form_id_card data_form_id_card_job>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" form="form-owner" name="id_card_nationality" id="id_card_nationality" class="form-control" placeholder="@lang('cms.Nationality')" data_form_id_card data_form_id_card_nationality>
...
<script>
    $(document).ready(function() {
            ...
            const response = await $.ajax({
                ...
                if (response.status == 422) {
                    ...
                    if (idCardErrors.length > 0) {
                        if (!document.querySelector('#file_ktp').value) {
        ...
        $('#bank_account_number').on('keydown', function(e) {
            if (!/^\d*$/.test(e.key) && !['c', 'v', 'x', 'Backspace', 'ArrowLeft', 'ArrowRight', 'Tab'].includes(e.key)) {
                e.preventDefault();
            }
        });
