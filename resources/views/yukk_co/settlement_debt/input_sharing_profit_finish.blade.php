        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-sm-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{ route("cms.yukk_co.settlement_debt.input_sharing_profit.form") }}" class="breadcrumb-item">@lang("cms.Settlement Debt Input Sharing Profit")</a>
                ...
                <div class="row mt-4">
                    <div class="col-12">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                            @php($sum_fee_partner = 0)
                            @foreach($settlement_debt_list as $index => $settlement_debt)
                                @php($sum_fee_partner += ($settlement_debt->total_fee_partner * -1))
                                <tr>
                                    ...
                                    <td class="text-right">{{ @\App\Helpers\H::formatNumber($settlement_debt->total_fee_partner * -1, 2) }}</td>
