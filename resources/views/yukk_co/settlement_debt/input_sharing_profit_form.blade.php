    ...
    <div class="page-header page-header-light">
        <div class="page-header-content d-sm-flex">
            <div class="page-title">
                ...
                <h4>@lang("cms.Settlement Debt Input Sharing Profit")</h4>
            </div>
        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-sm-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">@lang("cms.Settlement Debt Input Sharing Profit")</span>
                </div>
...
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">@lang("cms.Input Sharing Profit")</h5>
        ...
        <div class="card-body">
            <form action="{{ route("cms.yukk_co.settlement_debt.input_sharing_profit.summary") }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <input type="file" name="sharing_profits[]" class="file-input" multiple="multiple" data-fouc accept=".xlsx">
                    </div>
