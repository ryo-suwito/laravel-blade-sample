        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-sm-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{ route("cms.yukk_co.partner_mdr_pg.item", [$partner_id, $provider_id, $payment_channel_id]) }}" class="breadcrumb-item">@lang("cms.Detail")</a>
        ...
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form action="{{ route("cms.yukk_co.partner_mdr_pg.update", [$partner_id, $provider_id, $payment_channel_id]) }}" method="post" id="form">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <select name="active" class="form-control @if ($errors->has("active")) is-invalid @endif">
                                            <option value="1" @if( old("active", @$partner_mdr->active)) selected @endif>@lang("cms.Active")</option>
                                            <option value="0" @if(! old("active", @$partner_mdr->active)) selected @endif>@lang("cms.Inactive")</option>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="number" step="0.01" name="mdr_fee_fixed" class="form-control @if ($errors->has("mdr_fee_fixed")) is-invalid @endif" required="" value="{{ old("mdr_fee_fixed", @$partner_mdr->mdr_fee_fixed) }}">
                                        @if ($errors->has("active"))
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="input-group">
                                            <input type="number" step="0.01" name="mdr_fee_percentage" class="form-control @if ($errors->has("mdr_fee_percentage")) is-invalid @endif" required="" value="{{ old("mdr_fee_fixed", @$partner_mdr->mdr_fee_percentage) }}">
