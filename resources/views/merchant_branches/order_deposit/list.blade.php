...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route("cms.merchant_branch.order_deposit.list") }}" method="get">
                <div class="row">
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-3">         
                        <div class="form-group">
                            ...
                            <br/>          
                            <select id="platform_add" data-live-search="true" name="platform_id" data-live-search-style="contains" class="selectpicker" class="form-control">
                        ...
                        {{--<td class="text-center">
                            <div class="list-icons">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        --}}{{--<a href="{{ route("cms.merchant_branch.transaction_payment.show", $order_deposit->id) }}" class="dropdown-item"><i class="icon-search4"></i> @lang("cms.Detail")</a>--}}{{--
                                    </div>
                                </div>
                            </div>
                        </td>--}}
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="pagination pagination-flat justify-content-end">
                        ...
                        @else
                            <li class="page-item">
                                <a href="{{ route("cms.merchant_branch.order_deposit.list", array_merge(request()->all(), ["page" => $current_page-1])) }}" class="page-link"><i class="icon-arrow-left12"></i></a>
                            </li>
                        @endif
                        ...
                        @for ($i = max(1, $current_page - $plus_minus_range); $i <= min($current_page + $plus_minus_range, $last_page); $i++)
                            ...
                            @else
                                <li class="page-item">
                                    <a href="{{ route("cms.merchant_branch.order_deposit.list", array_merge(request()->all(), ["page" => $i])) }}" class="page-link">{{ $i }}</a>
                                </li>
                            @endif
                        @endfor
                        ...
                        @else
                            <li class="page-item">
                                <a href="{{ route("cms.merchant_branch.order_deposit.list", array_merge(request()->all(), ["page" => $current_page+1])) }}" class="page-link">
