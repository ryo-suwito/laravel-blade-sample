        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-sm-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">@lang("cms.Disbursement")</span>
                </div>
...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route("cms.partner.disbursement_partner.list") }}" method="get">
                <div class="row">
            ...
            <table class="table table-bordered table-striped dataTable">
                ...
                @foreach($disbursement_partner_list as $index => $disbursement_partner)
                    <tr>
                        ...
                        <td>{{ @\App\Helpers\H::formatDateTime($disbursement_partner->created_at) }}</td>
                        ...
                        <td class="text-center">
                            <div class="list-icons">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="{{ route("cms.partner.disbursement_partner.item", @$disbursement_partner->id) }}" class="dropdown-item"><i class="icon-search4"></i> @lang("cms.Detail")</a>
                                    </div>
                                </div>
                            </div>
                        </td>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="pagination pagination-flat justify-content-end">
                        ...
                        @else
                            <li class="page-item">
                                <a href="{{ route("cms.partner.disbursement_partner.list", array_merge(request()->all(), ["page" => $current_page-1])) }}" class="page-link"><i class="icon-arrow-left12"></i></a>
                            </li>
                        @endif
                        ...
                        @for ($i = max(1, $current_page - $plus_minus_range); $i <= min($current_page + $plus_minus_range, $last_page); $i++)
                            ...
                            @else
                                <li class="page-item">
                                    <a href="{{ route("cms.partner.disbursement_partner.list", array_merge(request()->all(), ["page" => $i])) }}" class="page-link">{{ $i }}</a>
                                </li>
                            @endif
                        @endfor
                        ...
                        @else
                            <li class="page-item">
                                <a href="{{ route("cms.partner.disbursement_partner.list", array_merge(request()->all(), ["page" => $current_page+1])) }}" class="page-link">
