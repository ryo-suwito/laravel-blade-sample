        ...
        <div class="breadcrumb-line breadcrumb-line-light header-elements-sm-inline">
            <div class="d-flex">
                <div class="breadcrumb">
                    ...
                    <a href="{{ route("cms.partner.transaction_pg.list") }}" class="breadcrumb-item">@lang("cms.Transaction Payment Gateway")</a>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-form-label">@lang("cms.Total MDR Fixed")</label>
                        <div class="col-lg-4">
                            <div class="form-group form-group-feedback form-group-feedback-left">
                        ...
                        <label class="col-lg-2 col-form-label">@lang("cms.Total MDR Percentage")</label>
                        <div class="col-lg-4">
                            <div class="form-group form-group-feedback form-group-feedback-left">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-2 col-form-label">@lang("cms.Partner Portion")</label>
                        <div class="col-lg-4">
                            <div class="form-group form-group-feedback form-group-feedback-left">
                                <input type="text" class="form-control" readonly="" value="{{ @\App\Helpers\H::formatNumber($transaction_pg->fee_partner_fixed + $transaction_pg->fee_partner_percentage, 2) }}">
                                <div class="form-control-feedback form-control-feedback-lg">
                                    @lang("cms.IDR")
                                </div>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" readonly="" value="{{ @\App\Helpers\H::formatDateTime($transaction_pg->paid_at) }}">
                        </div>
                    </div>
                </div>
            </div>
