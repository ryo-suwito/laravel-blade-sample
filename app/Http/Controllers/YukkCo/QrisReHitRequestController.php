...
class QrisReHitRequestController extends BaseController {
    ...
    public function index(Request $request) {
        ...
        $qris_re_hit_response = ApiHelper::requestGeneral("POST", ApiHelper::END_POINT_JALIN_QRIS_RE_HIT_LIST_YUKK_CO, [
            "query" => $query_params,
        ]);
        ...
        return view("yukk_co.qris_re_hits.list", [
    ...
    public function show(Request $request, $qris_re_hit_id) {
        ...
        $qris_re_hit_response = ApiHelper::requestGeneral("POST", ApiHelper::END_POINT_JALIN_QRIS_RE_HIT_ITEM_YUKK_CO, [
            "form_params" => [
        ...
        //dd($transaction_payment_response);
        return view("yukk_co.qris_re_hits.show", [
    ...
    public function create(Request $request) {
        ...
        return view("yukk_co.qris_re_hits.create", [
        ]);
    }
    ...
    public function store(Request $request) {
        ...
        $qris_re_hit_response = ApiHelper::requestGeneral("POST", ApiHelper::END_POINT_JALIN_QRIS_RE_HIT_STORE_YUKK_CO, [
        ...
        if ($qris_re_hit) {
            ...
            return redirect(route("cms.yukk_co.qris_re_hit.item", $qris_re_hit->id));
        } else {
            return $this->getApiResponseNotOkDefaultResponse($qris_re_hit_response);
        }
    }
    ...
    public function release(Request $request, $qris_re_hit_id) {
        ...
        if ($request->has("approve")) {
            $qris_re_hit_response = ApiHelper::requestGeneral("POST", ApiHelper::END_POINT_JALIN_QRIS_RE_HIT_APPROVE_YUKK_CO, [
                "form_params" => [
                    "qris_re_hit_request_id" => $qris_re_hit_id,
                ],
            ]);
            ...
            $qris_re_hit_response = ApiHelper::requestGeneral("POST", ApiHelper::END_POINT_JALIN_QRIS_RE_HIT_REJECT_YUKK_CO, [
                "form_params" => [
                    "qris_re_hit_request_id" => $qris_re_hit_id,
                ],
            ]);
