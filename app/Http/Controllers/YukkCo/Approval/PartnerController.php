...
class PartnerController extends Controller
{
    ...
    public function index(Request $request, GetApprovals $approvals, GetStatusCounter $counter)
    {
        ...
        return view('yukk_co.approval.index', [
            ...
            'routing' => 'approval.partners.index',
            'route' => 'approval.partners.action'
        ]);
    }
    ...
    public function show($id, GetApproval $approval)
    {
        return view('yukk_co.approval.show', [
            'title' => $this->title,
            'mainMenuUrl' => route('approval.partners.index'),
    ...
    public function update(Request $request, $id, UpdateApproval $approval)
    {
        ...
        return redirect()->route('approval.partners.show', ['id' => $id]);
    }

    public function showMaster($id, GetMaster $approval)
    {
        return view('yukk_co.approval.master.show-partner', [
            'title' => $this->title,
            'mainMenuUrl' => route('approval.partners.index'),
            'approvalUrl' => route('approval.partners.show', $id),
    ...
    public function toggleStatus(Request $request){
        ...
        if($response->is_ok){
            ...
            return redirect(route('approval.partners.index'));
        }else{
