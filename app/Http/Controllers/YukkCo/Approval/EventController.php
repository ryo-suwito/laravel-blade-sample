...
class EventController extends Controller
{
    ...
    public function index(Request $request, GetApprovals $approvals, GetStatusCounter $counter)
    {
        ...
        return view('yukk_co.approval.index', [
            ...
            'routing' => 'approval.events.index',
            'route' => 'approval.events.action'
        ]);
    }
    ...
    public function show($id, GetApproval $approval)
    {
        return view('yukk_co.approval.show', [
            'title' => $this->title,
            'mainMenuUrl' => route('approval.events.index'),
    ...
    public function update(Request $request, $id, UpdateApproval $approval)
    {
        ...
        return redirect()->route('approval.events.show', ['id' => $id]);
    }

    public function showMaster($id, GetMaster $approval)
    {
        return view('yukk_co.approval.master.show-event', [
            'title' => $this->title,
            'mainMenuUrl' => route('approval.events.index'),
            'approvalUrl' => route('approval.events.show', $id),
    ...
    public function toggleStatus(Request $request){
        ...
        if($response->is_ok){
            ...
            return redirect(route('approval.events.index'));
        }else{
