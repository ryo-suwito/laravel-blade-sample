...
class OwnerController extends Controller
{
    ...
    public function index(Request $request, GetApprovals $approvals, GetStatusCounter $counter)
    {
        ...
        return view('yukk_co.approval.index', [
            ...
            'routing' => 'approval.owners.index',
            'route' => 'approval.owners.action'
        ]);
    }
    ...
    public function show($id, GetApproval $approval)
    {
        return view('yukk_co.approval.show', [
            'title' => $this->title,
            'mainMenuUrl' => route('approval.owners.index'),
    ...
    public function update(Request $request, $id, UpdateApproval $approval)
    {
        try {
            ...
            return redirect()->route('approval.owners.show', ['id' => $id]);
        }
    ...
    public function showMaster($id, GetMaster $approval)
    {
        ...
        return view('yukk_co.approval.master.show-owner', [
            'title' => $this->title,
            'mainMenuUrl' => route('approval.owners.index'),
            'approvalUrl' => route('approval.owners.show', $id),
            'master' => $approval,
    ...
    public function toggleStatus(Request $request){
        ...
        if ($response->is_ok){
            ...
            return redirect(route('approval.owners.index'));
        } else {
