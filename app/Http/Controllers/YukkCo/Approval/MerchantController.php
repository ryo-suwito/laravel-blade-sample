...
class MerchantController extends Controller
{
    ...
    public function index(Request $request, GetApprovals $approvals, GetStatusCounter $counter)
    {
        ...
        return view('yukk_co.approval.index', [
            ...
            'routing' => 'approval.merchants.index',
            'route' => 'approval.merchants.action'
        ]);
    }
    ...
    public function show($id, GetApproval $approval)
    {
        return view('yukk_co.approval.show', [
            'title' => $this->title,
            'mainMenuUrl' => route('approval.merchants.index'),
    ...
    public function update(Request $request, $id, UpdateApproval $approval)
    {
        ...
        return redirect()->route('approval.merchants.show', ['id' => $id]);
    }

    public function showMaster($id, GetMaster $approval)
    {
        return view('yukk_co.approval.master.show-merchant', [
            'title' => $this->title,
            'mainMenuUrl' => route('approval.merchants.index'),
            'approvalUrl' => route('approval.merchants.show', $id),
    ...
    public function toggleStatus(Request $request){
        ...
        if($response->is_ok){
            ...
            return redirect(route('approval.merchants.index'));
        }else{
